...
class Router(XBeeDevice):
    ...
    def __init__(self, xbee_instance=None, camera_remote=True, local_camera=False):
...
if __name__ == '__main__':
    end_device = Router(xbee_instance=xbee_device, camera_remote=True, local_camera=False)
    end_device.run()